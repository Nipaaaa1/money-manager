...
<template>
  <section class="rounded-2xl bg-white p-6 shadow-sm">
    <h2 class="mb-4 text-lg font-bold">{{ $t('form.title') }}</h2>
    <form @submit.prevent="handleSubmit" class="space-y-4">
      <div class="space-y-4">
        <div>
          <label class="block text-xs font-semibold text-gray-500 uppercase mb-1">{{ $t('form.description') }}</label>
          <input
            v-model="description"
            type="text"
        ...
        <div>
          <label class="block text-xs font-semibold text-gray-500 uppercase mb-1">{{ $t('form.amount') }}</label>
          <input
        ...
        <div>
          <label class="block text-xs font-semibold text-gray-500 uppercase mb-2">{{ $t('form.type') }}</label>
